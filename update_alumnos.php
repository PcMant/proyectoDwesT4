...
$pag = new Phtml('Editar alumno');
$pag->openDiv("class='col-12 row justify-content-center'");
$pag->titulo('Editar alumno');
$pag->openForm("class='col-12 col-sm-12  col-lg-12 col-xl-3 row' action='php/con-mysql/update-alumnos.php'");

$pag->openDiv("class='mb-3'");
$pag->label('id','Id*',"class='form-label'");
$pag->input('number','id','id',"class='form-control' aria-describedby='id' required");
$pag->closeDiv();
...
$pag->button('submit','','','Editar registro','class="btn btn-primary w-100"');
$pag->closeDiv();
