...
<div class="col-12 row justify-content-center">
    <h1>Editar alumno</h1>
    <form class="col-12 col-sm-12  col-lg-12 col-xl-3" action="php/con-mysql/update-alumnos.php" method="get">
        <div class="mb-3">
        ...
        <div class="text-center"><button type="submit" class="btn btn-primary w-100">Editar registro</button></div>
    </form>
</div>
